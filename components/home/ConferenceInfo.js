    ...
    return (
      ...
      >
        ...
        <p className="text-lg text-gray-700 mb-6 leading-relaxed">
            The 8th International Conference on Computer Vision & Image Processing (CVIP-2023), a premier annual conference focused on Computer Vision and Image Processing will be held on November 03-05, 2023 at Indian Institute of Technology Jammu (IIT Jammu).
        </p>
        <p className="text-lg text-gray-700 mb-6 leading-relaxed">
            CVIP provides a great platform to students, academia, researchers and industry persons. Previous editions of CVIP were held at VNIT Nagpur (CVIP-2022), IIT Ropar (CVIP-2021), IIIT Allahabad (CVIP-2020), MNIT Jaipur (CVIP 2019), IIIT Jabalpur (CVIP-2018), and IIT Roorkee (CVIP-2017 and CVIP-2016). All editions of CVIP have been endorsed by the International Association for Pattern Recognition "IAPR". Also the conference proceedings are published in Springer Series on Communications in Computer and Information Science (CCIS) Springer.
        </p>
      </motion.div>
    );
  };
