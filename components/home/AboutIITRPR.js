    ...
    <div className="mt-6  min-h-[50vh] bg-gray-100 py-12">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <img
              src="/cvip2025/iitropar-pics/iitropar-pic-2.jpg"
          ...
          >
            ...
            <p className="text-lg leading-relaxed">
              ...
              campus with world-class facilities, renowned faculty, and a
              dynamic student community. The institute is dedicated to fostering
              innovation and excellence in various fields of study.
            </p>
          </motion.div>
        </div>
      </div>
