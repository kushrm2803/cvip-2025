        ...
        >
          <motion.section variants={sectionVariants} className="mb-8">
            ...
            <p className="text-base md:text-lg mb-4">
              ...
              research papers. In submitting a manuscript to CVIP 2024, authors
          ...
          <motion.section variants={sectionVariants} className="mb-8">
            ...
            <p className="text-base md:text-lg mb-4">
              ...
              Indexed – Springer in Communications in Computer and Information
              Science series. CCIS is abstracted/indexed in DBLP, Google
              Scholar, EI-Compendex, Mathematical Reviews, SCImago, Scopus. CCIS
              volumes are also submitted for inclusion in ISI Proceedings.
            </p>
          </motion.section>
          ...
          <motion.section variants={sectionVariants} className="mb-8">
            ...
            <p className="text-base md:text-lg mb-4">
              Authors can use the LaTeX2e Proceedings Templates available in the
          ...
          <motion.section variants={sectionVariants}>
            ...
            <p className="text-base md:text-lg mb-4">
              The manuscript has to be uploaded online at the CVIP 2024
